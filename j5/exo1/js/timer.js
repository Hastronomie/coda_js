export const timer = {
    ...
    createElements(container) {
        timer.elements.wrapper = document.createElement("div");
        timer.elements.wrapper.style.textAlign = "center";
        
        timer.elements.timer = document.createElement("p");
        
        timer.elements.goButton = document.createElement("button");
        timer.elements.goButton.textContent = "Go";
        
        timer.elements.resetButton = document.createElement("button");
        timer.elements.resetButton.textContent = "Recommencer";
    ...
    updateDisplay() {
        timer.elements.timer.textContent = `Temps : ${timer.data.minutes}:${timer.data.time}`;
    }, 
    ...
    attachEvents() {
        timer.elements.resetButton.addEventListener("click", this.resetTimer);
        timer.elements.stopButton.addEventListener("click", this.stoptimer);
        timer.elements.goButton.addEventListener("click", this.timer);
    },
